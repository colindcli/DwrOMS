    ...
    var objTable = {
        ...
        render: function () {
            ...
            $.tableObject({
                ...
                tableOption: {
                    url: "/clientApi/FinanceBuyOrder/GetPaidOrder",
                    page: true,
                    ...
                    cols: [
                        [listField.numbers,
                            ...
                            listField.defaultSettlementName,
                            {
                                ...
                                title: "付款时间",
                                width: 110,
                                templet: "<div>{{ d.PayFinishDate==null?'': d.PayFinishDate.ToDatetime() }}</div>"
                            },
                            {
                                field: "operator",
                                title: "操作",
            ...
            table.on("tool(" + self.tableId + ")", function (obj) {
                ...
                if (layEvent === "edit") {
                    win.iframe({
                        ...
                        url: 'financeBuyPaidOrderDetail.html?buyOrderId='+data.BuyOrderId,
                        done: function () {
                            //
                        },
                        close: function(){
