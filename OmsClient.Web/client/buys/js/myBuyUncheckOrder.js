    ...
    var objTable = {
        ...
        render: function () {
            ...
            $.tableObject({
                ...
                tableOption: {
                    url: "/clientApi/UserBuyOrder/GetBuyOrderListChecking",
                    page: true,
                    ...
                    cols: [
                        [listField.numbers,
                            ...
                            listField.defaultSettlementName,
                            {
                                ...
                                title: "提交时间",
                                width: 110,
                                templet: "<div>{{ d.PostCheckDate==null?'': d.PostCheckDate.ToDatetime() }}</div>"
                            },
                            {
                                field: "operator",
                                title: "操作",
            ...
            table.on("tool(" + self.tableId + ")", function (obj) {
                ...
                if (layEvent === "edit") {
                    win.iframe({
                        ...
                        url: 'myBuyUncheckOrderDetail.html?buyOrderId=' + data.BuyOrderId,
                        done: function () {
                            //
                        },
                        close: function () {
                    ...
                    win.confirm('确认退回修改吗？', function () {
                        $.postdata('/clientApi/UserBuyOrder/ReturnBackBuyOrder', {
