...
$(function () {
    ...
    var objOrder = {
        ...
        initData: function () {
            var self = this;
            //更新数据
            $.getdata('/clientApi/BuyStatistics/GetBuyOrderDetail?buyOrderId='+buyOrderId, {}, function(res){
        ...
        render: function () {
            ...
            $.tableObject({
                ...
                tableOption: {
                    url: "/clientApi/BuyStatistics/GetBuyOrderDetailProduct?buyOrderId="+buyOrderId,
                    page: false,
        ...
        finance: function(){
            var self = this;
            $.getdata('/clientApi/BuyStatistics/GetBuyPayRrcord?buyOrderId=' + buyOrderId, {}, function (res) {
